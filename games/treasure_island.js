...
var Level_1 = new Level(() =>
{
    ...
    e_1.speedY = -8,e_2.speedY = 8,e_3.speedY = -8,e_4.speedX = -8,e_5.speedX = 8;
    player.Update();
    e_1.Update();
    e_2.Update();
    e_3.Update();
    ...
    if(CheckCollisionRect(player,e_1) ||
...
Level_1.Start();
var MovePlayer = () => player_x += 5;
var MovePlayerPC = () => player_x += 20;
var BackPlayerPC = () => player_x -= 20;   
document.addEventListener("keydown",(e) =>
{
    if(e.key == "d" || e.keyCode == 39) MovePlayerPC();
    if(e.key == "a" || e.keyCode == 37) BackPlayerPC();
});           